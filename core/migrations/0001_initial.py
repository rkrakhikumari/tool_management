...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='board',
            name='organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='boards', to='core.organization'),
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='core.organization')),
            ],
        ),
        migrations.CreateModel(
            name='Label',
            fields=[
                ...
                ('tasks', models.ManyToManyField(blank=True, related_name='labels', to='core.task')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
